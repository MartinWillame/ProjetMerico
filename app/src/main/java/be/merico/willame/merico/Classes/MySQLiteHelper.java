...
public class MySQLiteHelper extends SQLiteOpenHelper {
     ...
     */
    private static final String DATABASE_SQL_FILENAME = "DatabaseMerico.sql";
    /**
     * Nom du fichier de la base de données.
     */
    private static final String DATABASE_NAME = "DatabaseMerico.sqlite";
    ...
    public static MySQLiteHelper get() {
        if (instance == null) {
            return new MySQLiteHelper(ProjetMerico.getContext());
        }
        return instance;
    }
    ...
    private void initDatabase(SQLiteDatabase db) {
        try {
            ...
            Scanner scan = new Scanner(ProjetMerico.getContext().getAssets().open(DATABASE_SQL_FILENAME));
